  ...
  return (
    <div className="h-screen bg-amber-50 dark:bg-neutral-800 text-gray-800 dark:text-white overflow-hidden">
      ...
      <div className="h-[calc(100vh-4rem)]">
        {currentPage === 'home' ? (
          /* Home Page */
          <div className="h-[85%] flex flex-col md:flex-row justify-center items-center px-4 md:px-8 md:py-0 pb-32 md:pb-0">
          ...
          /* Projects Page */
          <div className="h-full p-4 md:p-12 pb-32 md:pb-12 overflow-y-auto">
